...
public class Hydrocodone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hydrocodone);
        ...
        GoToMainActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Hydrocodone.this, MainActivity.class);
        ...
        GoToAddMedication.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Hydrocodone.this, AddMedication.class);
                startActivity(intent);
