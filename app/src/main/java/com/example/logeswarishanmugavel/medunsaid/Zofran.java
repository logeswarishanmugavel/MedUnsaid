...
public class Zofran extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zofran);
        ...
        GoToMainActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Zofran.this, MainActivity.class);
        ...
        GoToAddMedication.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Zofran.this, AddMedication.class);
                startActivity(intent);
