...
public class Keflex extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keflex);
        ...
        GoToMainActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Keflex.this, MainActivity.class);
        ...
        GoToAddMedication.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Keflex.this, AddMedication.class);
                startActivity(intent);
