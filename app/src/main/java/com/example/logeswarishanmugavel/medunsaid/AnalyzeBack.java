...
public class AnalyzeBack extends AppCompatActivity {

    ImageButton GoToHydrocodone;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_analyze_back);

        GoToHydrocodone = (ImageButton)findViewById(R.id.BackButton);

        GoToHydrocodone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AnalyzeBack.this, Hydrocodone.class);
